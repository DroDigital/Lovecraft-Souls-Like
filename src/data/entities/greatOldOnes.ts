...
export const GREAT_OLD_ONES = tier('great_old_one', [
  {
    ...
    ...scripted('boss', phases(
      ph(1, { tentacle_burst: 3, slam: 2, grab: 1, roar: 1 }, { hooks: ['camera_warp'] }),
      ph(0.66, { tentacle_burst: 2, slam: 2, wind_push: 2, roar: 1 }, { summons: ['star_spawn', 'star_spawn'], hooks: ['camera_warp', 'flood'] }),
      ph(0.33, { slam: 2, tentacle_burst: 2, grab: 2, wind_push: 1, roar: 1 }, { hooks: ['flood', 'camera_warp'], arena: 'ship' }),
    )),
  ...
  },
  {
    ...
    ...scripted('boss', phases(ph(1, { slam: 2, sweep: 2, wind_push: 1 }, { hooks: ['flood'] }), ph(0.5, { slam: 2, sweep: 1, roar: 1, charge: 1 }, { summons: ['deep_one', 'deep_one'], hooks: ['flood', 'darkness'] }))),
  ...
  },
  {
    ...
    ...scripted('boss', phases(ph(1, { grab: 2, pool: 1, tentacle_burst: 2 }, { hooks: ['flood'] }), ph(0.5, { tentacle_burst: 2, pool: 2, grab: 1, spit: 1 }, { summons: ['innsmouth_hybrid', 'innsmouth_hybrid'], hooks: ['flood'] }))),
  ...
  },
  {
    ...
    ...scripted('boss', { ...phases(
      ...
      ph(0.5, { darkness: 1, tentacle_burst: 2, gaze: 2, wind_push: 1 }, { hooks: ['camera_warp', 'darkness'] }),
      ph(0.2, { roar: 2, gaze: 2, beam: 1, teleport: 1 }, { hooks: ['camera_warp', 'darkness', 'time_skip'] }),
    ), called: true }),
  ...
  },
  {
    ...
    ...scripted('boss', phases(
      ph(1, { bite: 2, slam: 1, spit: 1 }),
      ph(0.5, { spit: 2, pool: 2, bite: 1 }, { summons: ['formless_spawn', 'formless_spawn'], hooks: ['darkness'] }),
      ph(0.2, { slam: 2, bite: 2, roar: 1 }, { hooks: ['darkness'] }),
    )),
  ...
  },
  {
    ...
    ...scripted('boss', phases(
      ph(1, { gaze: 2, tentacle_burst: 2, slam: 1 }, { hooks: ['petrify_buildup'], arena: 'monoliths' }),
      ph(0.5, { gaze: 2, tentacle_burst: 2, slam: 1, roar: 1 }, { hooks: ['petrify_buildup', 'camera_warp'] }),
    )),
  ...
  },
  {
    ...
    ...scripted('boss', phases(ph(1, { grab: 2, bite: 2, sweep: 1 }), ph(0.5, { grab: 2, bite: 1, charge: 1, roar: 1 }, { hooks: ['camera_warp'] }))),
  ...
  },
  {
    ...
    ...scripted('boss', phases(ph(1, { bite: 2, lunge: 2, spit: 1 }), ph(0.5, { bite: 2, lunge: 1, summon: 1, spit: 1, charge: 1 }, { summons: ['child_of_yig'] }))),
  ...
  },
  {
    ...
    ...scripted('boss', phases(ph(1, { bite: 2, charge: 1, pool: 1 }, { hooks: ['flood'] }), ph(0.5, { charge: 2, bite: 2, summon: 1, pool: 1 }, { summons: ['being_of_ib'], hooks: ['flood', 'camera_warp'] }))),
  ...
  },
  {
    ...
    ...scripted('boss', phases(ph(1, { bite: 2, slam: 2, roar: 1 }), ph(0.5, { slam: 2, charge: 1, roar: 1, aoe_ring: 1 }, { hooks: ['darkness'] }))),
  ...
  },
  {
    ...
    ...scripted('boss', phases(ph(1, { tentacle_burst: 2, spit: 2, darkness: 1 }), ph(0.5, { tentacle_burst: 2, pool: 2, spit: 1 }, { hooks: ['darkness'] }))),
    stats: st(7000, 1100, 66, 2.4, 5, 12), drops: { echoes: 9000 }, insightOnSight: 3,
  },
  {
    ...
    ...scripted('boss', phases(ph(1, { slam: 2, sweep: 2, teleport: 1 }), ph(0.5, { slam: 2, sweep: 1, teleport: 1, aoe_ring: 1 }, { hooks: ['hidden_platforms'] }))),
