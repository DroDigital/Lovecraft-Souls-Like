...
export const OUTER_GODS = tier('outer_god', [
  {
    ...
    ...scripted('boss', phases(
      ph(1, { roar: 2, darkness: 1, summon: 1, barrage: 2, eruption: 1 }, { summons: ['daemon_pipers'], hooks: ['darkness'] }),
      ph(0.66, { roar: 2, darkness: 1, summon: 1, barrage: 2, sweep_beam: 1, eruption: 1 }, { summons: ['daemon_pipers', 'other_gods'], hooks: ['darkness', 'camera_warp'] }),
      ph(0.33, { roar: 3, darkness: 1, summon: 1, barrage: 2, vortex: 1, eruption: 2 }, { summons: ['other_gods'], hooks: ['darkness', 'camera_warp', 'arena_reconnect'] }),
  ...
  },
  {
    ...
    ...scripted('caster', phases(ph(1, { roar: 2, projectile: 1, barrage: 1 }), ph(0.5, { roar: 1, projectile_fan: 2, darkness: 1, barrage: 2 }, { hooks: ['camera_warp'] }))),
  ...
  },
  {
    ...
    ...scripted('brute', phases(ph(1, { slam: 2, roar: 1, aoe_ring: 1, quake: 1 }), ph(0.5, { slam: 2, charge: 1, aoe_ring: 1, roar: 1, quake: 1, eruption: 1 }, { hooks: ['darkness'] }))),
  ...
  },
  {
    ...
    ...scripted('boss', phases(
      ph(1, { beam: 2, teleport: 1, aoe_ring: 1, barrage: 1, eruption: 1 }, { hooks: ['arena_reconnect'], arena: 'spheres' }),
  ...
  },
  {
    ...
    ...scripted('boss', phases(
      ph(1, { tentacle_burst: 2, charge: 1, pool: 1, summon: 1, eruption: 2 }, { summons: ['thousand_young'], arena: 'roots' }),
      ph(0.5, { tentacle_burst: 2, pool: 2, charge: 1, summon: 1, roar: 1, eruption: 1, quake: 1, vortex: 1 }, { summons: ['thousand_young'], hooks: ['darkness'] }),
    )),
  ...
  },
  {
    ...
    ...scripted('boss', phases(
      ...
      ph(0.3, { tentacle_burst: 2, grab: 1, roar: 1, vortex: 1, quake: 1 }, { hooks: ['darkness', 'camera_warp'] }), // the Crawling Chaos: it borrows the slain bosses' attacks too
