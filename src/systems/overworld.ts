...
export function createOverworld(sign: string): Overworld {
  return { sign, discovered: new Set([sign]), slain: new Set(), killed: new Set(), read: new Set(), named: 0, called: new Set(), ending: null, alive: new Map(), region: null, chunk: -1, dirty: true, explored: new Map(), lookedFrom: -1 };
}
