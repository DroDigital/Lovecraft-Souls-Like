...
function baseGame(world: CollisionWorld, spawn: Place, seed: number): Game {
  ...
  const g: Game = {
    ...
    player: { id, buffer: createBuffer(), dodgeHeld: -1, sprinting: false, blockHeld: false, blockRaised: false, echoes: 0, checkpoint: { ...spawn }, laudanum: LAUDANUM.doses, reagent: REAGENT.doses, reagentMax: REAGENT.doses },
    mind: createMind(),
