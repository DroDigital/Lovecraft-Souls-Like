...
- Creatures are data, not classes. A typical entity is 15–30 lines of data. Bosses get phase scripts, and those are data too.
...
- **Resolution:** render to a low-res target (default 400×225, configurable) and upscale with nearest-neighbor filtering.
- **World geometry:**
  - low-poly and vertex-lit
  - procedural 64×64 textures: stone, wood, rot, wet flesh, water
  - vertex snapping
  - affine texture wobble, emulated because WebGL2 has no `noperspective`: pass uv·w and divide in the fragment shader
...
- **Creatures:** instanced billboard sprites, generated at startup from each entity's `sprite` recipe.
  ...
  - Each state gets 2–4 frames, and everything is packed into one atlas.
...
- **Post-processing:** one fullscreen post pass handles everything:
  ...
  2. Palette quantization (64 colors or fewer) with 4×4 Bayer dithering.
...
- Poise and stagger apply to both the player and enemies. Hits get 2–4 frames of hitstop.
- Lock-on:
...
### C. Entity registry
- `src/data/roster.ts` holds every id from §4 and is the source of truth.
- `EntityDef` fields:
...
- Where Lovecraft barely describes something (Hastur, Nug, Yeb, the Unnamable…), design from the textual hints and set `canonLooks: false`.
- Scope is Lovecraft's own fiction, including his revisions and collaborations.
  ...
  - If you are confident something from his fiction is missing from §4, add it and log it in DECISIONS.md.

### D. World
- Streaming:
  - 64 m chunk grid
  - load a 5×5 area around the player, and unload chunks beyond 7×7
...
- The Dreamlands are entered by resting at the hub's special Elder Sign. The path is: 70 Steps of Light Slumber → Cavern of Flame → 700 Steps of Deeper Slumber.

| Region | Legacy dungeon | Boss(es) |
|---|---|---|
| Hub: Miskatonic University | University Library | — |
...
| Dreamlands | Ulthar → Leng → Vaults of Zin → Kadath | High Priest Not to Be Described; Bokrug; the Great Ones & Nyarlathotep |
| Mu & R'lyeh | Risen R'lyeh | Ghatanothoa; Cthulhu |
| Yuggoth | Mi-Go cities | Rhan-Tegoth; Hastur |
| Beyond the Gate | The Ultimate Void | 'Umr at-Tawil → Yog-Sothoth → Azathoth's Court |
...
**lesser:** Deep One · Innsmouth Hybrid · Esoteric Order of Dagon Priest · Cthulhu Cultist · Ghoul · Ghast · Zoog · Night-gaunt · Moon-beast · Man of Leng · Cat from Saturn · Wamp · Gnorri · Serpent Man of Valusia · K'n-yan Dweller · Y'm-bhi · Gyaa-yothn · Reanimated Corpse (Herbert West) · Martense Degenerate · Exham Priory Troglodyte · Rat Swarm · Winged Hybrid (The Festival) · Moon-Bog Wraith · Being of Ib · Nameless City Reptile · Hybrid Mummy (Under the Pyramids) · Venusian Man-Lizard · The Beast in the Cave · Child of Yig (snake swarm) · Blind Albino Penguin (ambient)

**greater:** Mi-Go · Elder Thing · Shoggoth · Star-spawn of Cthulhu · Yithian · Flying Polyp · Gug · Dhole · Shantak · Formless Spawn of Tsathoggua · Yekubian · Being from Beyond (visible only when Unmoored or through Tillinghast's resonator) · Thousand Young of Shub-Niggurath (original design, not the RPG's "Dark Young")

**named:** The Colour Out of Space · Wilbur Whateley · The Dunwich Horror · Keziah Mason · Brown Jenkin · The Black Man (Nyarlathotep avatar) · Joseph Curwen · Simon Orne · Edward Hutchinson · Things in Curwen's Pits · Ephraim Waite · The Haunter of the Dark (Nyarlathotep avatar) · The Whisperer in Akeley's Chair · The Hound · The Unnamable · The Shunned House Entity · Lilith (Red Hook) · The Thing Beyond Erich Zann's Window · The Voice in the Tomb · High Priest Not to Be Described · The Colossus Beneath the Pyramids · The Horror at Martin's Beach · Dr. Muñoz · Charles le Sorcier · The Gorgon of Medusa's Coil · Hypnos · The Outsider · The Terrible Old Man

**great_old_one:** Cthulhu · Father Dagon · Mother Hydra · Hastur · Tsathoggua · Ghatanothoa · Rhan-Tegoth · Yig · Bokrug · Nug · Yeb · The Great Ones (gods of Earth)

**outer_god:** Azathoth · The Daemon Pipers · The Other Gods · Yog-Sothoth · 'Umr at-Tawil · The Ancient Ones · Shub-Niggurath · Nyarlathotep (Crawling Chaos pharaoh + true form)

**ally (non-hostile by default):** Nodens · Tritons of Nodens' Court · Cats of Ulthar · Richard Upton Pickman (ghoul) · Nasht & Kaman-Thah · The Light-Being from Algol · Yithian Archivist
...
- **Phase 0: Scaffold & look**
  ...
  - Write `CLAUDE.md` (40 lines or fewer): commands, folder map, the §0 rules condensed, and a pointer to this spec.
  - Build the §2 pipeline with a test scene: a terrain patch, some pillars, and one anomaly object.
...
- **Phase 1: Player & combat**
  - Implement §3B in a flat arena against a training dummy and one placeholder Deep One.
  - Tests: stamina, i-frame windows, input buffer, lock-on scoring.
- **Phase 2: Registry & bestiary**
  - Implement §3C: schema, archetypes, sprite generator, and every §4 entry as data, one file per tier. Boss scripts can be one-phase stubs for now.
...
- **Phase 3: Sanity & Insight**
  - Implement §3A, the HUD bars, and all four hooks.
  - Tests: band transitions and hysteresis, variant swap, hidden layers.
- **Phase 4: World**
  - Implement §3D: streaming, regions, the dungeon kit, checkpoints, the death/Echo loop, fast travel, and save/load (localStorage JSON).
  - Test: every roster entity is reachable, meaning it appears in a spawn table, a boss arena, or an ally location.
- **Phase 5: Bosses**
  - Implement §3E in batches: 5a named, 5b great old ones, 5c outer gods plus three endings.
  - The three endings: wake and seal the Gate · pass through with 'Umr at-Tawil · become Nyarlathotep's herald.
...
- **Phase 6: Audio & polish**
  ...
  - Performance pass to meet the §2 budgets.
